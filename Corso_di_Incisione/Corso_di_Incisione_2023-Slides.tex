...
\begin{document}
	...
	\begin{frame}{Le tecniche originali}
		\begin{tabularx}{\textwidth}{XXX}
			...
			\captionof{figure}{Matrice calcografica}
			}&{
			\centering
	...
	\begin{frame}{Le tecniche originali}
		\begin{tabularx}{\textwidth}{XXX}
			...
			\captionof{figure}{Stampa calcografica}
			}&{
			\centering
	...
	\begin{frame}{La stampa di traduzione}
		...
		\begin{tabularx}{\linewidth}{XX}
			...
			\captionof{figure}{\centering Egidius Sadeler, Deposizione da Barocci, bulino/acquaforte}
			}
		\end{tabularx}
	\end{frame}
	...
	\begin{frame}{Stampa di invenzione}
		...
		\end{tabularx}
		\centering
		\small{Leonardo Castellani, Natura morta e Paesaggio, acqueforti}
	\end{frame}
	...
	\begin{frame}{Varianti di stato}
		\begin{tabularx}{\linewidth}{XXXX}
			{
			\centering
			\zoombox{\includegraphics[width=3cm]{Pablo Picasso11.png}}
			}&{
			\centering
			\zoombox{\includegraphics[width=3cm]{Pablo Picasso10.png}}
			}&{
			\centering
			\zoombox{\includegraphics[width=3cm]{Pablo Picasso9.png}}
			}&{
			\centering
			\zoombox{\includegraphics[width=3cm]{Pablo Picasso8.png}}
			}
		\end{tabularx}
		\begin{tabularx}{\linewidth}{XXXX}
			{
			\centering
			% La quinta immagine
			\zoombox{\includegraphics[width=3cm]{Pablo Picasso7.png}}
			}&{
			\centering
			\zoombox{\includegraphics[width=3cm]{Pablo Picasso6.png}}
			}&{
			\centering
			\zoombox{\scalebox{-1}[1]{\includegraphics[width=3cm]{Pablo Picasso5.png}}}
			}&{
			\centering
			\zoombox{\includegraphics[width=3cm]{Pablo Picasso4.png}}
			}
		\end{tabularx}
		\begin{tabularx}{\linewidth}{XXXX}
			{
			\centering
			\zoombox{\includegraphics[width=3cm]{Pablo Picasso3.png}}
			}&{
			\centering
			\zoombox{\includegraphics[width=3cm]{Pablo Picasso2.png}}
			}&{
			\centering
			\zoombox{\includegraphics[width=3cm]{Pablo Picasso1.png}}
			}&{
			\vspace*{-20mm}
			\begin{flushleft}
	...
	\begin{frame}{Tiratura, segnatura e numerazione}
		\begin{tabularx}{\linewidth}{XXX}
			{
				\centering
				\zoombox{\includegraphics[scale=0.09]{Pablo Picasso, soggetti dalla serie 347-1.png}}
			}&{
				\centering
				\hspace*{1.7mm}
				\zoombox{\includegraphics[scale=0.2]{Pablo Picasso, soggetti dalla serie 347-2.png}}
			}&{
				\centering
				\zoombox{\includegraphics[scale=0.205]{Pablo Picasso, soggetti dalla serie 347-3.png}}
			}
		\end{tabularx}
		\centering
		\small{Pablo Picasso, soggetti dalla serie 347, esemplari di Bon a tirer, Prova d’artista e in numerazione araba}
	\end{frame}
	...
	\begin{frame}{Libri consigliati}
		\begin{tabularx}{\linewidth}{XXXX}
			{
				\centering
				\zoombox{\includegraphics[width=1.5cm]{Libro1.png}}
			}&{
				\centering
				\zoombox{\includegraphics[width=1.5cm]{Libro2.png}}
			}&{
				\centering
				\zoombox{\includegraphics[width=1.5cm]{Libro3.png}}
			}&{
				\centering
				\zoombox{\includegraphics[width=1.5cm]{Libro4.png}}
			}
		\end{tabularx}
		\begin{tabularx}{\linewidth}{XXXX}
			{
				\centering
				\zoombox{\includegraphics[width=1.5cm]{Libro5.png}}	
			}&{
				\centering
				\zoombox{\includegraphics[width=1.5cm]{Libro6.jpg}}
			}&{
				\centering
				\zoombox{\includegraphics[width=1.5cm]{Libro7.png}}
			}&{
				\centering
				\zoombox{\includegraphics[width=1.5cm]{Libro8.jpg}}
			}
		\end{tabularx}
		\begin{tabularx}{\linewidth}{XXXXXXX}
			{
				\centering
				\zoombox{\includegraphics[width=1.5cm]{Libro9.png}}
			}&{
				\centering
				\zoombox{\includegraphics[width=1.5cm]{Libro10.jpg}}
			}&{
				\centering
				\zoombox{\includegraphics[width=1.5cm]{Libro11.jpg}}
			}&{
				\centering
				\zoombox{\includegraphics[width=1.5cm]{Libro12.jpg}}
			}&{
				\centering
				\zoombox{\includegraphics[width=1.5cm]{Libro13.jpg}}
			}&{
				\centering
				\zoombox{\includegraphics[width=1.5cm]{Libro14.jpg}}
			}&{
				\centering
				\zoombox{\includegraphics[width=1.5cm]{Libro15.jpg}}
			}
		\end{tabularx}
	\end{frame}
